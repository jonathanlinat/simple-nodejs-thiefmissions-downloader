  ...
  _getHeaders() {
    return __awaiter(this, void 0, void 0, function* () {
      if (this._opts.followRedirect) {
        const redirResult = yield request_1.followRedirect(
          this._url,
        ...
        const headerResult = yield request_1.requestHeader(
          this._url,
          this._opts.httpOptions
        )
  ...
  _report(id, force) {
    ...
    if (force || now - this._partsSpeedRef[id].time > interval) {
      this.partsProgress[id].speed =
        (1000 *
          (this.partsProgress[id].bytes - this._partsSpeedRef[id].bytes)) /
  ...
  _download(id, range) {
    return __awaiter(this, void 0, void 0, function* () {
      for (const attempt of this._attempts) {
        ...
        yield helpers_1.delay(
          this._opts.retryDelay + this._opts.retryBackoff * (attempt - 1)
        )
      }
